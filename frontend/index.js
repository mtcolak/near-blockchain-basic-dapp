...
const wallet = new Wallet({ createAccessKeyFor: "dev-1667417271662-11014977411942" })

// Abstract the logic of interacting with the contract to simplify your project
const contract = new Contract({ contractId: "dev-1667417271662-11014977411942", walletToUse: wallet });
...
async function getInformation(){
  ...
  if (wallet.isSignedIn()) {
    await contract.withdraw_storage(
      {},
  let get_info = await contract.account_information();
